...
#ifndef CYGNUS_GAZEBO_PLUGINS_MOTOR_MODELS_H
#define CYGNUS_GAZEBO_PLUGINS_MOTOR_MODELS_H
...
#include "cygnus_gazebo_plugins/motor_model.hpp"
...
#endif // CYGNUS_GAZEBO_PLUGINS_MOTOR_MODELS_H
